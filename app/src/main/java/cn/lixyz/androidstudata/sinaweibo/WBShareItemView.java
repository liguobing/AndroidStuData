...
public class WBShareItemView extends LinearLayout {
	 ...
	 * 用资源 ID 来初始化界面元素。
	 */
	public void initWithRes(int titleResId, int thumbResId, int shareTitleResId, int shareDescResId,
			int shareUrlResId) {
	 ...
	 * 初始化界面元素。
	 */
	public void initWithData(String title, Drawable thumb, String shareTitle, String shareDesc, String shareUrl) {
